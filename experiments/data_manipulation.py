...
from scripts.util import save_simulation_results, visualize_data_manipulation_results
...
results_dir = os.path.join("results", "data_manipulation_experiment", f"run_{timestamp}")
...
visualize_data_manipulation_results(results_dir, df_summary, df_results)
