...
if __name__ == "__main__":
    ...
    results["Bribery"] = run_bribery_simulation(votes, value_matrix, ideal_scores,metrics,num_voters,num_projects,budget)
   

    
    print("Running Manipulation Simulation...")
    results["Manipulation"]= run_manipulation_simulation(votes, value_matrix, ideal_scores,metrics,num_voters,num_projects)
    
    print("Running Deletion Simulation...")
    results["Deletion"] = run_deletion_simulation(votes, value_matrix, ideal_scores,metrics,num_voters,num_projects)
    
    print("Running Cloning Simulation...")
    results["Cloning"] = run_cloning_simulation(votes, value_matrix, ideal_scores,metrics,num_voters,num_projects)
